...
background = pygame.image.load('C:\\Users\\PC\\Downloads\\galaxy_bg.png').convert()
background = pygame.transform.scale(background, (SCREEN_WIDTH, SCREEN_HEIGHT))
pygame.display.set_caption("Galaxy Defenders")
icon = pygame.image.load('C:\\Users\\PC\\Downloads\\galaxy_icon.png')
pygame.display.set_icon(icon)

playerImg = pygame.image.load('C:\\Users\\PC\\Downloads\\galaxy_player.png')
...
for i in range(num_of_enemies):
    img = pygame.image.load('C:\\Users\\PC\\Downloads\\galaxy_enemy.png')
...
bulletImg = pygame.image.load('C:\\Users\\PC\\Downloads\\galaxy_bullet.png')
...
def fire_bullet(x, y):
    global bullet_state
    bullet_state = "fire"
    screen.blit(bulletImg, (bulletX + PLAYER_SIZE // 2 - BULLET_WIDTH // 2, bulletY))
def isCollision(enemyX, enemyY, bulletX, bulletY):
    # Check if there is a collision between the enemy and a bullet
    distance = math.sqrt(
    ((enemyX + ENEMY_SIZE // 2) - (bulletX + BULLET_WIDTH // 2)) ** 2 +
    ((enemyY + ENEMY_SIZE // 2) - (bulletY + BULLET_HEIGHT // 2)) ** 2)
